...
from .scrap_google_weather_page_for_django import gather_weather_data_interia_better_solution, gather_weather_data_google_better_solution
...
def index(request):
    weather_data_list_interia = gather_weather_data_interia_better_solution('https://pogoda.interia.pl/prognoza-szczegolowa-barczewo,cId,662')
